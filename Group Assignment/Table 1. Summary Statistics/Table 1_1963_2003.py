...
# Paper sample for replication: 1963–2003
# Formation years (Table 1 convention): 1968–2002
...
comp.to_csv(
    os.path.join(SAVE_PATH, "Compustat_funda_1963_2003.csv"),
    index=False
)
print("Saved RAW: Compustat_funda_1963_2003.csv")
...
# =========================
link_raw.to_csv(
    os.path.join(SAVE_PATH, "Crsp_compustat_link_1963_2003.csv"),
    index=False
)
print("Saved RAW: Crsp_compustat_link_1963_2003.csv")
...
# =========================
crsp_m.to_csv(
    os.path.join(SAVE_PATH, "Crsp_monthly_1963_2003.csv"),
    index=False
)
print("Saved RAW: Crsp_monthly_1963_2003.csv")

# 보통주 + NYSE/AMEX/NASDAQ
crsp_m = crsp_m[
...
# ✅ 논문 Table 1 replication: formation years로 제한
comp_ccm = comp_ccm[
...
print("\n=== Table 1 (Decile time-series means) ===")
...
print("\n=== Final Table 1 (with Spread rows) ===")
print(final_table1.round(4))

# (선택) 저장
final_table1.to_csv("Table1_Summary_with_ACCRUALS_ISSUANCE_1963_2003.csv")
print("\nSaved: Table1_Summary_with_ACCRUALS_ISSUANCE_1963_2003.csv")